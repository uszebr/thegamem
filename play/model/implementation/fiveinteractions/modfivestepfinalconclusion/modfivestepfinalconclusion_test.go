...
func TestModelCopyStartGreen(t *testing.T) {
	...
	tests := []struct {
		...
		{myHistory: []signal.Signal{signal.Green}, opHistory: []signal.Signal{signal.Red}, result: signal.Green},
		{myHistory: []signal.Signal{signal.Red}, opHistory: []signal.Signal{signal.Green}, result: signal.Green},

		//two signal history
		{myHistory: []signal.Signal{signal.Red, signal.Red}, opHistory: []signal.Signal{signal.Red, signal.Red}, result: signal.Green},
		{myHistory: []signal.Signal{signal.Red, signal.Red}, opHistory: []signal.Signal{signal.Red, signal.Green}, result: signal.Green},
		{myHistory: []signal.Signal{signal.Green, signal.Green}, opHistory: []signal.Signal{signal.Green, signal.Red}, result: signal.Green},
	...
	for index, testl := range tests {
		...
		t.Run(fmt.Sprintf("Test: %v", index), func(t *testing.T) {
			model := Modfivestepfinalconclusion{}.GetModel()
